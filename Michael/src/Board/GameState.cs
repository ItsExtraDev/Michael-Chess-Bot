...
namespace Michael.src
{
    ...
    public static class GameState
    {
        ...
        private const int MovingPieceMask = 0b000000000000111111; // bits 0-5
        private const int CapturedPieceMask = 0b000000111111000000; // bits 6-11
        private const int EnPassantSquareMask = 0b111111000000000000; // bits 12-17
        // Castling rights stored in remaining upper bits (bit 18+)

        // --- Bit shifts for packing values into a single integer ---
        private const int CapturedPieceShift = 6;
        private const int EnPassantShift = 12;
        private const int CastlingShift = 18;
        ...
        /// </summary>
        private const int CastlingMask = 0b1111 << CastlingShift; // 4 bits for castling
        public static int GetCastlingRights(int gameState)
            => (gameState & CastlingMask) >> CastlingShift;
